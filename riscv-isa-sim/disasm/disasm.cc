...
void disassembler_t::add_instructions(const isa_parser_t* isa)
{
  ...
  if (isa->has_any_vector()) {
    ...
    add_insn(new disasm_insn_t("vlshfte64.v",  match_vlshfte64_v,     mask_vlshfte64_v, v_ld_stride));
    add_insn(new disasm_insn_t("vsshfte64.v",  match_vsshfte64_v,     mask_vsshfte64_v, v_st_stride));
    add_insn(new disasm_insn_t("vlc8to32.v",  match_vlc8to32_v,     mask_vlc8to32_v, v_ld_unit));
    add_insn(new disasm_insn_t("vstrcmp.vv",  match_vstrcmp_vv,     mask_vstrcmp_vv, {&vd, &vs1, &vs2}));
